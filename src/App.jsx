...
function App() {
  ...
  return (
    <div className="bg-rose100 font-red_hat_text min-h-screen gap-8 flex md:flex-row flex-col lg:px-padding_x_large px-padding_x_small sm:py-padding_y py-padding_y_small">
      <CartItemsProvider>
